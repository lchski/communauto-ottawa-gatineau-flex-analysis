...
This chart tells us that there was never a week where all 30 cars were observed to be in service at once. This isn’t a huge surprise, given the combination of expected usage and maintenance. (The chart also tells us that something odd happened in early December—we [dive into that on another page](/availability/snow-events).)
...
So Communauto lived up to its offer of 30 cars (for the most part). But how easy were they to access? How often could you access a car near _you_, or some other point of interest? Let’s dive into that next.
